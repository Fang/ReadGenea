...
index = c(ind.devid +1, ind.config + 1:3, ind.trial + 1:4, ind.subinfo + 1:7, ind.memstatus + 1)
...
freq = as.numeric(scan(fc, skip = index[12], what = "", n = 2, sep = ":", quiet = TRUE)[2])
