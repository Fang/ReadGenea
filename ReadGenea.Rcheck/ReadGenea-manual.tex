...
\end{Examples}
\inputencoding{utf8}
\HeaderA{get.intervals}{Methods for processing and summarising AccData.}{get.intervals}
\aliasA{\$.AccData}{get.intervals}{.Rdol..AccData}
\aliasA{AccData}{get.intervals}{AccData}
\aliasA{plot.AccData}{get.intervals}{plot.AccData}
\aliasA{print.AccData}{get.intervals}{print.AccData}
\aliasA{[.AccData}{get.intervals}{[.AccData}
...
plot(x, mode = c("decibels", "modulus", "pval"), log = "", showmax = TRUE, median = FALSE, xaxis = TRUE, topthresh, reassign = (!(is.null(x$LGD)) && !("mv" %in% x$type)), ylim, xlim,new = TRUE, zlim.raw,zlim.quantile, cex = 2, col = gray (63:0/63),...)
## S3 method for class 'stft'
print(x, ...)
\end{verbatim}
\end{Usage}
